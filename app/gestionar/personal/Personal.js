...
(function () {
  angular.module('SGCD')
    .controller('PersonalCtrl', ['$uibModal', function ($uibModal) {
      var self = this;
      self.personal = [
        {
          categoria: {
      ...
      self.total = 91.56;
      self.mediaCreditos = 24;

      self.info = function (cat) {
        $uibModal.open({
          templateUrl: './gestionar/personal/infoPersonalView.html',
          controller: 'InfoPersonalCtrl as info',
          size: 'md',
          resolve: {
    ...
    .controller('InfoPersonalCtrl', ['$uibModalInstance', 'categoriaSeleccionada', function ($uibModalInstance, categoriaSeleccionada) {
      var self = this;
      self.categoriaConDedicacion = categoriaSeleccionada;
